...
static const lcm_setting_table_t lcd_init_cmd_g[] = {
        ...
        {0x11, 0, {0x00}},		/* Sleep out */
        {REGFLAG_DELAY, 120, {}},	/* Delayms (120) */
        {0x36, 2, {0x00, 0x00}},	/* Memory Data Access Control */
        {0x3A, 2, {0x00, 0x55}},	/* Interface Pixel format 0x55 for RGB565. Since we use RGB565(16 bit color format), we should set it to 0x55 and not 0x66. */
        {0xB0, 2, {0x00, 0x10}},	/* RAM control */
        {0xB2, 10, {0x00, 0x0C, 0x00, 0x0C, 0x00, 0x00, 0x00, 0x33, 0x00, 0x33}}, /* Porch Setting */
        ...
        {0x2A, 8, {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xEF}},	/* Column Address Set */
        {0x2B, 8, {0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x3F}},	/* Row Address Set */
        {0x21, 0, {0x00}},	/* Display Inversion On */
        {0x29, 0, {0x00}},	/* Display On */
        {REGFLAG_END_OF_TABLE, 0, {}},
};
