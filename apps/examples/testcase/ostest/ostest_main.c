...
#ifdef CONFIG_TESTING_OSTEST_STDIO
...
#ifdef CONFIG_TESTING_OSTEST_ENVIRON
...
#ifdef CONFIG_TESTING_OSTEST_VFORK
  printf("\nuser_main: vfork() test\n");
  vfork_test();
  check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_FORK
  printf("\nuser_main: fork() test\n");
  fork_test();
  check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_ARGUMENT
...
#ifdef CONFIG_TESTING_OSTEST_TLS
  /* Test TLS */
...
#ifdef CONFIG_TESTING_OSTEST_SCHED_THREAD_LOCAL
...
#endif
    {
#ifdef CONFIG_TESTING_OSTEST_SETVBUF
      /* Checkout setvbuf */
...
#ifdef CONFIG_TESTING_OSTEST_DEV_NULL
...
#ifdef CONFIG_TESTING_OSTEST_FPU
...
#ifdef CONFIG_TESTING_OSTEST_RESTART
...
#ifdef CONFIG_TESTING_OSTEST_WAITPID
...
#ifdef CONFIG_TESTING_OSTEST_MULTIUSER
...
#ifdef CONFIG_TESTING_OSTEST_MUTEX
...
#ifdef CONFIG_TESTING_OSTEST_TIMEDMUTEX
      printf("\nuser_main: timed mutex test\n");
      timedmutex_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_RMUTEX
...
#ifdef CONFIG_TESTING_OSTEST_SPECIFIC
...
#ifdef CONFIG_TESTING_OSTEST_CANCEL
...
#ifdef CONFIG_TESTING_OSTEST_ROBUST
      printf("\nuser_main: robust test\n");
      robust_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_SEM
...
#ifdef CONFIG_TESTING_OSTEST_SEMTIMED
      printf("\nuser_main: timed semaphore test\n");
      semtimed_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_NSEM
      printf("\nuser_main: Named semaphore test\n");
      nsem_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_COND
...
#ifdef CONFIG_TESTING_OSTEST_PTHREAD_EXIT
...
#ifdef CONFIG_TESTING_OSTEST_PTHREAD_RWLOCK
...
#ifdef CONFIG_TESTING_OSTEST_PTHREAD_RWLOCK_CANCEL
      printf("\nuser_main: pthread_rwlock_cancel test\n");
      pthread_rwlock_cancel_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_PTHREAD_CLEANUP
...
#ifdef CONFIG_TESTING_OSTEST_TIMEDWAIT
...
#ifdef CONFIG_TESTING_OSTEST_TIMEDMQUEUE
...
#ifdef CONFIG_TESTING_OSTEST_SIGPROCMASK
...
#ifdef CONFIG_TESTING_OSTEST_MQUEUE
      /* Verify pthreads and message queues */
...
#ifdef CONFIG_TESTING_OSTEST_SUSPEND
      printf("\nuser_main: signal action test\n");
      suspend_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_SIGHAND
...
#ifdef CONFIG_TESTING_OSTEST_SIGNEST
      printf("\nuser_main: nested signal handler test\n");
      signest_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_POSIXTIMER
...
#ifdef CONFIG_TESTING_OSTEST_SPINLOCK
      printf("\nuser_main: spinlock test\n");
      spinlock_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_WDOG
      printf("\nuser_main: wdog test\n");
      wdog_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_HRTIMER
      /* Verify hrtimer */
...
#ifdef CONFIG_TESTING_OSTEST_SIGEV_THREAD
...
#ifdef CONFIG_TESTING_OSTEST_ROUNDROBIN
...
#ifdef CONFIG_TESTING_OSTEST_SPORADIC
...
#ifdef CONFIG_TESTING_OSTEST_SPORADIC2
      printf("\nuser_main: Dual sporadic thread test\n");
      sporadic2_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_BARRIER
...
#ifdef CONFIG_TESTING_OSTEST_SETJMP
...
#ifdef CONFIG_TESTING_OSTEST_PRIOINHERIT
...
#ifdef CONFIG_TESTING_OSTEST_SCHEDLOCK
      printf("\nuser_main: scheduler lock test\n");
      sched_lock_test();
      check_test_memory_usage();
#endif

#ifdef CONFIG_TESTING_OSTEST_SMP_CALL
      printf("\nuser_main: smp call test\n");
      smp_call_test();
#endif

#ifdef CONFIG_TESTING_OSTEST_NXEVENT
      /* Verify nxevent */
...
#ifdef CONFIG_TESTING_OSTEST_PERF_GETTIME
